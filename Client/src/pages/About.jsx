...
import { Ticket, Calendar, Users, Star, ArrowRight } from 'lucide-react';
      ...
      <section className="relative py-24 bg-green-700 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-xl text-green-100 max-w-2xl mx-auto leading-relaxed">
            Amra biswas kori prottekta event-er pichone thake ekta golpo. Amader platform-er lokkho holo sei golpo gulo ke sohoje manush-er kache pouchiye dewa.
          </p>
        </div>
      </section>
      ...
      <section className="relative -mt-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 text-center">
          {stats.map((stat, index) => (
            <div key={index} className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-gray-600">Jhamela-mukto ticket booking system, ja apnar shomoy bachabe.</p>
              </div>
            </div>
            ...
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-gray-600">Music fest theke shuru kore tech workshop—shob dhoroner event ek-i jaygay.</p>
              </div>
            </div>
            ...
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-gray-600">Event create kora theke shuru kore analytics dekha, shob-i khub shohoj.</p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h2 className="text-2xl md:text-3xl font-medium italic text-gray-800 leading-relaxed">
            "This platform changed the way we host our annual tech conferences. The attendee management is world-class!"
          </h2>
          <div className="mt-8">
